...
import { Calendar, Users, ArrowUpRight, ArrowDownRight, Activity } from 'lucide-react';
            ...
            <div className="bg-[#EAF3FF] p-4 rounded-xl relative overflow-hidden">
                <div className="flex justify-between items-start mb-2">
                    <div>
                        ...
                        <h3 className="text-3xl font-bold text-gray-900 mt-1">27</h3>
                    </div>
            ...
            <div className="bg-[#FFE4E6] p-4 rounded-xl relative overflow-hidden">
                <div className="flex justify-between items-start mb-2">
                    <div>
                        ...
                        <h3 className="text-3xl font-bold text-gray-900 mt-1">11<span className="text-gray-400 text-lg">/16</span></h3>
                    </div>
