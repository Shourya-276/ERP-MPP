...
export default function RegistrationColumnModifier() {
  const [selectedColumns, setSelectedColumns] = useState<string[]>([
    "Sr no", "Name", "Wing - Flat no", "Required Payment", "Registration", "Sm Name"
  ]);
  ...
  const selectAll = () => setSelectedColumns(REGISTRATION_COLUMNS);
